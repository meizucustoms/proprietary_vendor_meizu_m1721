...
LOCAL_MODULE_OWNER := meizu
LOCAL_SRC_FILES := etc/qdcm_calib_data_nili7807d_txdkj_1080p_video_mode_dsi_panel.xml
LOCAL_MODULE_TAGS := optional
...
LOCAL_MODULE_OWNER := meizu
LOCAL_SRC_FILES := etc/qdcm_calib_data_hx8399c_tcl_1080p_video_mode_dsi_panel.xml
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_SUFFIX := .xml
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_OWNER := meizu
LOCAL_SRC_FILES := etc/qdcm_calib_data_hx8399c_holitech_1080p_video_mode_dsi_panel.xml
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_SUFFIX := .xml
include $(BUILD_PREBUILT)
